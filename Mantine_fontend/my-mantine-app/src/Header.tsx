...
import { UserButton } from "./Component";
...
export function HeaderMegaMenu() {
  ...
  return (
    <Box pb={120}>
      <Header height={60} px="md" style={{ backgroundColor: "black" }}>
        <Group position="apart" sx={{ height: "100%" }}>
          {/* <MantineLogo  size={30}  /> */}
          <img src="https://we.croled.vn/Images/logo-while.png" height={30} />
          ...
          <Group className={classes.hiddenMobile}>
            <UserButton  image="" name="Hội" email="mrh@gmail.com" style={{ overflow: "hidden" }} />
          </Group>
      ...
      <Drawer opened={drawerOpened} onClose={closeDrawer} size="100%" padding="md" title="Navigation" className={classes.hiddenDesktop} zIndex={1000000}>
        <ScrollArea h={`calc(100vh - ${rem(60)})`} mx="-md">
          ...
          <Group position="center" grow pb="xl" px="md">
            <UserButton image="" name="Hội" email="mrh@gmail.com" />
          </Group>
        </ScrollArea>
      </Drawer>
    </Box>
